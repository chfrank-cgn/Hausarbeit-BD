...
\hypersetup{ % Thema und Author in die Meta-Daten der PDF
  ...
  pdfkeywords={Web, Traffic, Analysis, Analytics, E-Marketing, KPI}
}
...
\begin{abstract}
This paper will analyze blog post performance with data taken by Plausible website analytics, enhance it with categorization and sentiment analysis, and aim to make predictions on future blog post performance.
